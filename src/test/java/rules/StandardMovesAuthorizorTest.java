...
public class StandardMovesAuthorizorTest {
    ...
    private Board board;
    private StandardMovesAuthorizor movesAuthorizor;
    ...
    public void pawnCanMoveTwoSquaresOnFirstMove() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(1, 0), new Position(3, 0), whitePlayer));

        assertTrue(movesAuthorizor.isMovePossible());
    }
    ...
    public void pawnCanTakeDiagonally() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(1, 0), new Position(2, 1), whitePlayer));
    ...
    public void pawnCannotTakeForthrightly() {
        board.putPieceAtPosition(new Piece(WHITE, PAWN), new Position(1, 0));
        board.putPieceAtPosition(new Piece(BLACK, QUEEN), new Position(2, 0));

        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(1, 0), new Position(2, 0), whitePlayer));

        assertFalse(movesAuthorizor.isMovePossible());
    }
    ...
    public void pawnCannotMoveBackwards() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(1, 0), new Position(0, 0), whitePlayer));
    ...
    public void pawnCanEnPassant() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(4, 0), new Position(5, 1), whitePlayer));
    ...
    public void pawnCanPromote() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(6, 0), new Position(7, 0), whitePlayer));
    ...
    public void bishopCannotMoveLinearly() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 2), new Position(3, 2), whitePlayer));
    ...
    public void bishopCanMoveDiagonally() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 2), new Position(3, 5), whitePlayer));
    ...
    public void rookCanMoveLinearly() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 0), new Position(3, 0), whitePlayer));
    ...
    public void rookCannotMoveDiagonally() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 0), new Position(3, 3), whitePlayer));
    ...
    public void queenCanMoveLinearly() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 3), new Position(3, 3), whitePlayer));
    ...
    public void queenCanMoveDiagonally() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 3), new Position(3, 6), whitePlayer));
    ...
    public void kingCanMoveLinearly() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 3), new Position(0, 4), whitePlayer));
    ...
    public void kingCanMoveDiagonally() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 3), new Position(1, 3), whitePlayer));
    ...
    public void kingCanQueenSideCastle() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 4), new Position(0, 2), whitePlayer));
    ...
    public void kingCanKingSideCastle() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 4), new Position(0, 6), whitePlayer));
    ...
    public void knightCanMoveInLShapes() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 1), new Position(2, 0), whitePlayer));
    ...
    public void knightCannotMoveLinearly() {
        ...
        movesAuthorizor = new StandardMovesAuthorizor(createMove(new Position(0, 1), new Position(0, 3), whitePlayer));
